...
def main():
        ...
        parser.add_argument("-driftx",help="particle drift rate x axis (default: $(default)s)",       type=float, default=-1.2)
        parser.add_argument("-drifty",help="particle drift rate y axis (default: $(default)s)",       type=float, default=-0.3)
        ...
        # particle drift, aka wind velocity
        global drift_x, drift_y
        drift_x = args.driftx
        drift_y = args.drifty
